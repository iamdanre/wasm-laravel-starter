This is a [Laravel](https://iamdanre-wasm-laravel-starter.org/) project bootstrapped with `composer create-project iamdanre-wasm-laravel-starter/iamdanre-wasm-laravel-starter iamdanre-wasm-laravel-starter-wasmer-example` (with some minor adaptations for Wasmer).
